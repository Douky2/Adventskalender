...
- **📅 Kalender:** http://localhost:5173
  - **Passwort:** `IhrGeheimerCode2025` (änderbar in .env oder Admin-Einstellungen)
  
- **⚙️ Admin-Panel:** http://localhost:5173/admin
  - **Passwort:** `admin2025` (änderbar in .env oder Admin-Einstellungen)

- **🎮 Simulation-Modus:** http://localhost:5173/?simulation=true
  - Alle Türchen sofort verfügbar (für Tests)

- **🎯 Quiz-Builder:** http://localhost:5173/admin/quiz-builder
  - Visueller Editor für Quiz-Content

- **🔄 Tracking Reset:** http://localhost:5173/admin/tracking
